 ...
 * (по макету). На десктопе (sm:+) — обратно карточка с фоном/рамкой/тенью,
 * как было изначально: на ПК-ширине пункт без оболочки читался слишком
 * бедно и неотличимо от мобильной версии.
 *

    ...
    <header className="sticky top-0 z-40 border-b border-divider-elevated bg-surface-page-surf1">
      <div className="container-page flex h-14 items-center justify-between gap-4 sm:h-[83px]">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          >
            {/* контурный колокольчик с отдельным язычком — вектор из набора
                макета; рамка 24×24 квадратная, тогда как прежний PNG-экспорт
                был обрезан по контенту (отсюда были размеры 16×17 и 22×24) */}
            <ActionIcon name="bellHeader" className="h-[18px] w-[18px] sm:h-6 sm:w-6" />

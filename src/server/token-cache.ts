 ...
 * последнего действия человека. Бронь держится 30 минут, казначей обычно
 * отвечает в первые, так что практический случай покрыт. Когда Ecash
 * починят WebSocket, мгновенные события закроют остальное.
 */

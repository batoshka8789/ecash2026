 ...
 *
 * Минута между проходами — компромисс: казначей отвечает за минуты, бронь
 * держится до часа — задержка в минуту погоды не делает; чаще — лишние
 * запросы к ядру на каждый проход по каждой заявке.
 */

const INTERVAL_MS = 60_000;
/** Заявки старше суток не наблюдаем: бронь держится до часа, индивидуальный курс — часы. */
